  ...
  days: [
    {
      ...
      name: "Monday",
      appointments: [1, 2, 3],
      interviewers: [1, 2] // added for getInterviewersForDay test
    },
    {
      id: 2,
      name: "Tuesday",
...
/**
 * still creating the tests based on the others. Not sure if I should alter the tests, the function or the mock data in order to pass.. I guess I should write it to test what I expect.
 */
// --- - -- -- --- - - - -- - - -- - -- -- -- -  ---- - -
